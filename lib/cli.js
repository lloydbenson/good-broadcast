...
internals.logLastIndex = function (index, path, callback) {
...
exports.run = function (options) {
    ...
    determineStart((error1, start, result) => {
        ...
        Utils.recursiveAsync({ start, result, previous }, processLog, (err) => {
